...
public class BlockConstants {
    ...
    static {
        ...
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_EDGE_DIRT_UP, BLOCK_TYPE_FLOOR_DECORATION);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_EDGE_DIRT_LEFT, BLOCK_TYPE_FLOOR_DECORATION);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_EDGE_DIRT_RIGHT, BLOCK_TYPE_FLOOR_DECORATION);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_EDGE_DIRT_DOWN, BLOCK_TYPE_FLOOR_DECORATION);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_EDGE_SAND_UP, BLOCK_TYPE_FLOOR_DECORATION);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_EDGE_SAND_LEFT, BLOCK_TYPE_FLOOR_DECORATION);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_EDGE_SAND_RIGHT, BLOCK_TYPE_FLOOR_DECORATION);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_EDGE_SAND_DOWN, BLOCK_TYPE_FLOOR_DECORATION);
