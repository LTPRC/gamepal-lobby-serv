...
public class BlockConstants {
    ...
    static {
        ...
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DIRT, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_SAND, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_GRASS, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_SNOW, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_SWAMP, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_ROUGH, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_SUBTERRANEAN, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_LAVA, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_WATER, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_EDGE_DIRT_UP, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_EDGE_DIRT_LEFT, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_EDGE_DIRT_RIGHT, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_EDGE_DIRT_DOWN, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_EDGE_SAND_UP, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_EDGE_SAND_LEFT, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_EDGE_SAND_RIGHT, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_EDGE_SAND_DOWN, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_WOODEN_FLOOR_1, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_WOODEN_FLOOR_2, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_STONE_FLOOR_1, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_STONE_FLOOR_2, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_BITUMEN, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_BRICK_1, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_BRICK_2, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_BRICK_3, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_BRICK_4, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_BRICK_5, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_BRICK_6, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_BRICK_7, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_BRICK_8, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_LIME_WALL, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_HALF_LIME_WALL, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DOOR_1, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DOOR_2, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DOOR_3, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DOOR_4, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DOOR_5, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DOOR_6, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DOOR_7, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DOOR_8, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DOOR_9, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DOOR_10, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DOOR_11, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DOOR_12, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DOOR_13, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DOOR_14, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DOOR_15, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DOOR_16, BLOCK_TYPE_NORMAL);
        ...
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_WINDOW_1, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_WINDOW_2, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_WINDOW_3, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_WINDOW_4, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_WINDOW_5, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_WINDOW_6, BLOCK_TYPE_NORMAL);
        ...
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_DOCUMENT, BLOCK_TYPE_NORMAL);
        ...
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_CROP_1, BLOCK_TYPE_EFFECT);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_CROP_2, BLOCK_TYPE_EFFECT);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_CROP_3, BLOCK_TYPE_EFFECT);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_CROP_0, BLOCK_TYPE_EFFECT);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_ROCK_1, BLOCK_TYPE_ROCK);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_ROCK_2, BLOCK_TYPE_ROCK);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_RAFFLESIA, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_STUMP, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_MOSSY_STUMP, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_HOLLOW_TRUNK, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_FLOWER_BUSH, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_BUSH, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_SMALL_FLOWER_1, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_SMALL_FLOWER_2, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_SMALL_FLOWER_3, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_BIG_FLOWER_1, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_BIG_FLOWER_2, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_BIG_FLOWER_3, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_MUSHROOM_1, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_MUSHROOM_2, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_GRASS_1, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_GRASS_2, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_GRASS_3, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_GRASS_4, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_CACTUS_1, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_CACTUS_2, BLOCK_TYPE_NORMAL);
        BLOCK_CODE_TYPE_MAP.put(BLOCK_CODE_CACTUS_3, BLOCK_TYPE_NORMAL);
